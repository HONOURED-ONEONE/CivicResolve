...
- `feature/intelligence-cluster-pack`: Intelligence Service `/cluster` and `/pack` endpoint implementation.
...
3. **Merge Order**:
   - Establish base API schemas first (Intelligence Service / Orchestrator base models).
   - Implement standalone endpoints/workers.
   - Finally, merge integration code (e.g., Orchestrator calling Intelligence Service).
